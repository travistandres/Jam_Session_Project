...
import {getAudioFiles,createAudioFile,updateAudioFile,deleteAudioFile,
...
const [rowData, setRowData] = useState([
  ...
  return (
    <div className="px-20 py-12 flex flex-col" style={{ backgroundColor: "#1a181b" }}>
        ...
        {audioFiles.map((file, index) => (
          ...
          >
            ...
            <div className="w-1/4 text-center">
              <audio controls>
                <source src={`data:audio/mp3;base64,${file.audio}`} type="audio/mpeg" />
